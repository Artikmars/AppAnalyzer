...
public class PhoneRecyclerViewAdapter
        extends RecyclerView.Adapter<PhoneRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view =
                LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.phone_list_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        switch (position) {
            case 0:
                viewHolder.mainItemName.setText("Applications");
                break;
            case 1:
                viewHolder.mainItemName.setText("Applications Categories");
                break;
            case 2:
                viewHolder.mainItemName.setText("Average Permissions Amount per Category");
                break;
            case 3:
                viewHolder.mainItemName.setText("Potentially Dangerous Applications");
                break;
        }
