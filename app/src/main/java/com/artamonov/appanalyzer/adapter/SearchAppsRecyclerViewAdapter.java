...
public class SearchAppsRecyclerViewAdapter extends RecyclerView.Adapter<SearchAppsRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchAppsRecyclerViewAdapter(List<String> searchApps, ArrayList<String> arrayLinks, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.search_app_item, viewGroup, false);
